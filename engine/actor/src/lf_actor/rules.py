...
_ROUTINE_PATTERNS: dict[str, tuple[str, tuple[str, ...]]] = {
    "achievement": ("work", (
        ...
        "작은 것 하나를 끝내고, 다음 것을 곧장 집어 들었다",
        "잘 되지 않는 부분을 붙잡고 몇 번이고 다시 들여다봤다",
    )),
    "belonging": ("observe", (
        "사람들의 근황을 살피며 조용히 지냈다",
        "익숙한 얼굴들 곁을 맴돌며 시간을 보냈다",
        "연락할까 말까 망설이며 한동안을 흘려보냈다",
        "오가는 대화 언저리에서 웃을 자리를 찾으며 지냈다",
        "누군가의 안부가 궁금해지는 밤을 몇 번 넘겼다",
    )),
    "security": ("rest", (
        "생활의 리듬을 지키며 조용히 지냈다",
        "무리하지 않는 선에서 하루하루를 정리했다",
        "익숙한 일과를 반복하며 마음을 다독였다",
        "흐트러진 주변을 정돈하며 숨 고를 자리를 만들었다",
        "큰일 없이 지나가는 하루하루에 조용히 안도했다",
    )),
}
